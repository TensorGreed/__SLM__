...
_BUILTIN_RECIPES: list[dict[str, Any]] = [
    ...
    {
        "recipe_id": "recipe.kd.classification",
        "display_name": "Offline KD — Classification",
        "description": (
            "Distill a captured teacher's soft labels into a small classifier-style "
            "causal LM. Train against teacher_capture.jsonl (no live teacher at train "
            "time). Pair with a class-balanced capture set."
        ),
        "category": "distillation",
    ...
    {
        "recipe_id": "recipe.kd.qa",
        "display_name": "Offline KD — Q&A / Instruction",
        "description": (
            "Distill a captured teacher's token distributions for instruction / QA "
            "answers into a small student. Soft targets sharpen short-answer phrasing "
            "the hard labels alone underdetermine."
        ),
        "category": "distillation",
    ...
    {
        "recipe_id": "recipe.kd.span_extraction",
        "display_name": "Offline KD — Span Extraction",
        "description": (
            "Distill a captured teacher's distributions for structured / span-extraction "
            "outputs into a small student. Soft targets help the student match the "
            "teacher's confident boundaries and JSON structure."
        ),
        "category": "distillation",
